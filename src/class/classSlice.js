    ...
    extraReducers(builder){
        builder
            ...
            .addCase(createClass.fulfilled,(state,action)=>{
                ...
                state.classes.push(Number(action.payload))
            })
            .addCase(updateClass.fulfilled,(state,action)=>{
                const c = action.payload
                const classes = state.classes.filter(t => t.id !== c.id)
                state.classes = [...classes,c]
            })
            .addCase(deleteClass.fulfilled,(state,action) =>{
                const c = state.classes.filter(t => t.id !== Number(action.payload))
                state.classes = c
            })
...
export const getAllClasses = (state) => state.classes.classes
export const selectClassById = (state,classId) => state.classes.classes.find(c => c.id === classId)
