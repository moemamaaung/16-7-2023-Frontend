...
import { createAccordion, selectAccordionById, updateAccordion } from './accordionSlice'
...
const EditAccordion = () => {
  ...
  const w =`  ${classes.w}`
    ...
    const accordions = useSelector((state)=>selectAccordionById(state,Number(accordionId))) 
  ...
  const canSave = [id,subtimea,subtimeb,subtimec,subtimed,subtimee,subtimef,subtimeg,subtimeg,
